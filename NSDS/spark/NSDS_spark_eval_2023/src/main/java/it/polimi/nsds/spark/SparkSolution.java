...
public class SparkSolution {
    ...
    public static void main(String[] args) throws TimeoutException {
        ...
        final StreamingQuery q2 = videosCourses
                .join(
                    visualizations,
                    visualizations.col("value").equalTo(videosCourses.col("video_id"))
                )
                .drop("course_hours", "course_students")
                .groupBy(
         ...
         * with respect to the number of students in the course of that video.
         */
